...
class_per_row <- rownames(stats_by_class_mat36)
...
save(class_per_row, group_per_cell, class_per_cell, odour_names, odour_groups, stats_by_class_mat36, file=output.file)
print("Done.")
